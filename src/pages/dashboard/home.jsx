...
export function Home() {
  ...
  return (
    <div className="mt-12">
      <div className="bg-red-700 hidden text-white rounded-lg p-2 fixed bottom-28 md:bottom-8 right-8 z-40 vsm:flex cursor-pointer hover:ring-4 hover:ring-red-200">
    ...
    {/* weather card */}
    <div className="w-full md:w-5/6 my-5 md:my-10 bg-white m-auto p-5 vsm:p-10 rounded-xl ring-8 ring-white ring-opacity-40">

      <div className="flex justify-between">
        <div className="flex flex-col w-full">
          <div className="flex justify-between">
            <p className="text-base vsm:text-lg md:text-2xl font-bold">Good Morning</p>
            <p className="text-xs vsm:text-base items-center">Fri, 22 Sep 2024</p>
          </div>
          
          <span className="mt-1 text-sm vsm:text-base text-black ">Pura Sakenan, Denpasar</span>
        </div>
      ...
      <div className="flex justify-between mt-2 vsm:mt-12">
        <div className="flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">29°C</span>
          ...
          <span className="font-semibold mt-1 text-xs vsm:text-sm">11:00</span>
          <span className="text-xs font-semibold text-gray-400">AM</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">31°C</span>
          <img src={sunnycloudy} alt="alternative" className="h-10 w-10 mt-3"/>
          {/* {/* {/* <svg className="h-10 w-10 fill-current text-gray-400 mt-3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79zM1 10.5h3v2H1zM11 .55h2V3.5h-2zm8.04 2.495l1.408 1.407-1.79 1.79-1.407-1.408zm-1.8 15.115l1.79 1.8 1.41-1.41-1.8-1.79zM20 10.5h3v2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm-1 4h2v2.95h-2zm-7.45-.96l1.41 1.41 1.79-1.8-1.41-1.41z"/></svg> */} 
          <span className="font-semibold mt-1 text-xs vsm:text-sm">1:00</span>
          <span className="text-xs font-semibold text-gray-400">PM</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">32°C</span>
          <img src={sunnycloudy} alt="alternative" className="h-10 w-10 mt-3"/>
          ...
          <span className="font-semibold mt-1 text-xs vsm:text-sm">3:00</span>
          <span className="text-xs font-semibold text-gray-400">PM</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">31°C</span>
          <img src={sunnycloudy} alt="alternative" className="h-10 w-10 mt-3"/>
          <span className="font-semibold mt-1 text-xs vsm:text-sm">5:00</span>
          <span className="text-xs font-semibold text-gray-400">PM</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">27°C</span>
          <img src={sunny} alt="alternative" className="h-10 w-10 mt-3"/>
          <span className="font-semibold mt-1 text-xs vsm:text-sm">7:00</span>
          <span className="text-xs font-semibold text-gray-400">PM</span>
        </div>
        <div className="hidden md:flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">27°C</span>
          <img src={sunny} alt="alternative" className="h-10 w-10 mt-3"/>
          <span className="font-semibold mt-1 text-xs vsm:text-sm">9:00</span>
          <span className="text-xs font-semibold text-gray-400">PM</span>
        </div>
        <div className="hidden md:flex flex-col items-center">
          <span className="font-semibold text-sm vsm:text-lg">27°C</span>
      ...
      <p className="mt-2 text-xs vsm:text-base vsm:mt-5 mb-1 vsm:mb-2">Data by BMKG</p>
      <hr/>
      <div className="flex justify-around mt-1 vsm:mt-4">
        <div className="flex flex-col items-center">
          <img src={temp} alt="alternative" className="h-5 w-5 vsm:h-10 vsm:w-10 mt-3"/>
          <span className="mt-1 text-xs vsm:text-sm">Temperature</span>
          <span className="text-base font-medium vsm:font-semibold vsm:text-lg">{data["temperature"].toFixed(2)} °C</span>
        </div>
        <div className="flex flex-col items-center">
          <img src={humid} alt="alternative" className="h-5 w-5 vsm:h-10 vsm:w-10 mt-3"/>
          <span className="mt-1 text-xs vsm:text-sm">Humidity</span>
          <span className="text-base font-medium vsm:font-semibold vsm:text-lg">{data["humidity"].toFixed(2)} %</span>
        </div>
      </div>
      <div className="flex justify-center mt-1 vsm:mt-4">
        <div className="flex flex-col items-center md:mt-3">
          <img src={wind} alt="alternative" className="h-5 w-5 vsm:h-10 vsm:w-10 mt-3"/>
          <span className="mt-1 text-xs vsm:text-sm">Wind Speed</span>
          <span className="text-base font-medium vsm:font-semibold vsm:text-lg">{data["wind_speed"]} m/s</span>
        </div>
      </div>
      {/* <RealTimeData /> */}
    </div>
